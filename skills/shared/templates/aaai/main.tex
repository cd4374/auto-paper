...
\begin{figure}[t]
\centering
\fbox{\rule{0pt}{1.2in}\rule{0.9\columnwidth}{0pt}} % Placeholder figure box; replace with your actual figure.
...
\begin{figure*}[t]
\centering
\fbox{\rule{0pt}{1.4in}\rule{0.8\textwidth}{0pt}} % Placeholder wide figure box; replace with your actual figure.
