...
\begin{abstract}
%% Text of abstract
Abstract example for the Results in Physics Journal. Here you provide a brief summary of the research and the results.
\end{abstract}
...
\begin{figure}
	\centering 
	\fbox{\rule{0pt}{1.2in}\rule{0.4\textwidth}{0pt}}	
