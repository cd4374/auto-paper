%%%%%%%% ICML TEMPLATE EXAMPLE LATEX SUBMISSION FILE %%%%%%%%%%%%%%%%%
...
\icmltitlerunning{Submission and Formatting Instructions for ICML (target year)}

\begin{document}

\twocolumn[
\icmltitle{Submission and Formatting Instructions for \\
           International Conference on Machine Learning (ICML (target year))}
...
Submission to ICML (target year) will be entirely electronic, via a web site
...
\vskip 0.2in
\begin{center}
\centerline{\fbox{\rule{0pt}{1.4in}\rule{\columnwidth}{0pt}}}
